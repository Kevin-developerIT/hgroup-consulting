...
export const translations = {
  en: {
    ...
    contact: {
      headline: "Let's talk.",
      intro: 'Tell us about your brand, your goals, or the campaign you have in mind. We read every message.',
      name: 'Name',
      email: 'Email',
      ...
      errorMessage: 'Something went wrong. Please try again or write us directly at alberto.v@hgroup.consulting',
    },
    presentation: {
      title: '',
      tagline: ''
  ...
  es: {
    ...
    contact: {
      headline: 'Hablemos.',
      intro: 'Cuéntanos sobre tu marca, tus objetivos o la campaña que tienes en mente. Leemos cada mensaje.',
      name: 'Nombre',
      email: 'Correo',
      ...
      errorMessage: 'Algo salió mal. Inténtalo de nuevo o escríbenos directamente a alberto.v@hgroup.consulting',
    },
    presentation: {
      title: '',
      tagline: ''
